...
__export(index_exports, {
  ...
  BaseWS: () => BaseWS,
  BearCallSpreadSkill: () => BearCallSpreadSkill,
  BullPutSpreadSkill: () => BullPutSpreadSkill,
  BuyAtmCallSkill: () => BuyAtmCallSkill,
  Charts: () => Charts,
  Constants: () => constants_exports,
  CoveredCallSkill: () => CoveredCallSkill,
  ...
  IpSetup: () => IpSetup,
  IronCondorSkill: () => IronCondorSkill,
  LTPStore: () => LTPStore,
  LiveTradingDisabledError: () => LiveTradingDisabledError,
  MARKET_HOLIDAYS: () => MARKET_HOLIDAYS,
  MarketDataSummarizerSkill: () => MarketDataSummarizerSkill,
  MarketFeed: () => MarketFeed,
  MarketFeedWS: () => MarketFeedWS,
  McpServer: () => McpServer,
  NetworkError: () => NetworkError,
  OPTION_CHECKS: () => OPTION_CHECKS,
  OptionChain: () => OptionChain,
  OrderStore: () => OrderStore,
  OrderUpdateWS: () => OrderUpdateWS,
  Orders: () => Orders,
  PROMPTS: () => PROMPTS,
  Pipeline: () => Pipeline,
  Policy: () => Policy,
  Positions: () => Positions,
  Profile: () => Profile,
  PromptHelpers: () => promptHelpers_exports,
  ProtectivePutSkill: () => ProtectivePutSkill,
  READ_SCOPES: () => READ_SCOPES,
  RESOURCES: () => RESOURCES,
  RateLimitError: () => RateLimitError,
  RateLimiter: () => RateLimiter,
  RiskViolationError: () => RiskViolationError,
  SUPPORTED_PROTOCOL_VERSIONS: () => SUPPORTED_PROTOCOL_VERSIONS,
  Skill: () => Skill,
  SkillRegistry: () => SkillRegistry,
  SquareOffAllSkill: () => SquareOffAllSkill,
  SquareOffPositionSkill: () => SquareOffPositionSkill,
  Statements: () => Statements,
  StraddleSkill: () => StraddleSkill,
  StrangleSkill: () => StrangleSkill,
  SuperOrders: () => SuperOrders,
  TIMEFRAMES: () => TIMEFRAMES,
  TechnicalAnalysis: () => TechnicalAnalysis,
  TokenManager: () => TokenManager,
  ToolSchemas: () => schemas_exports,
  TraderControls: () => TraderControls,
  ...
  candlesFromSeries: () => candlesFromSeries,
  closes: () => closes,
  concentrationCheck: () => concentrationCheck,
  createSkillRegistry: () => createSkillRegistry,
  describeTool: () => describeTool,
  detailedMaxPain: () => detailedMaxPain,
  ema: () => ema,
  erf: () => erf,
  findStrike: () => findStrike,
  fixedRiskSize: () => fixedRiskSize,
  ...
  marketHoursCheck: () => marketHoursCheck,
  maxLossCheck: () => maxLossCheck,
  maxPain: () => maxPain,
  nearestStrike: () => nearestStrike,
  normalCdf: () => normalCdf,
  normalPdf: () => normalPdf,
  normalizeOptionChain: () => normalizeOptionChain,
  obv: () => obv,
  openInterestFromChain: () => openInterestFromChain,
  optionsCheck: () => optionsCheck,
  orderConfirmation: () => orderConfirmation,
  orderSchema: () => orderSchema,
  orderTypeCheck: () => orderTypeCheck,
  parseCsv: () => parseCsv,
  parseMarketFeedPacket: () => parseMarketFeedPacket,
  parseTimestamp: () => parseTimestamp,
  percentageStop: () => percentageStop,
  portfolioSummary: () => portfolioSummary,
  positionLimitsCheck: () => positionLimitsCheck,
  previewOrder: () => previewOrder,
  previousTradingDay: () => previousTradingDay,
  price: () => price,
  productSupportCheck: () => productSupportCheck,
  putCallRatio: () => putCallRatio,
  quantityCheck: () => quantityCheck,
  resample: () => resample,
  resolveChain: () => resolveChain,
  resolveEquityChain: () => resolveEquityChain,
  resolveIndexChain: () => resolveIndexChain,
  riskProviderFor: () => riskProviderFor,
  riskReport: () => riskReport,
  riskTypeFor: () => riskTypeFor,
  rsi: () => rsi,
  sma: () => sma,
  splitPackets: () => splitPackets,
  stochastic: () => stochastic,
  superOrderSchema: () => superOrderSchema,
  supertrend: () => supertrend,
  supportStop: () => supportStop,
  systemPrompt: () => systemPrompt,
  takeProfit: () => takeProfit,
  toIstDateString: () => toIstDateString,
  todayOrLastTradingDay: () => todayOrLastTradingDay,
  tradingDaysAgo: () => tradingDaysAgo,
  tradingPermissionCheck: () => tradingPermissionCheck,
  trueRanges: () => trueRanges,
  volatilitySize: () => volatilitySize,
...
__export(constants_exports, {
  ALERT_CONDITION_SEGMENTS: () => ALERT_CONDITION_SEGMENTS,
  AmoTime: () => AmoTime,
  ...
  FOREVER_ORDER_PRODUCT_TYPES: () => FOREVER_ORDER_PRODUCT_TYPES,
  FOREVER_ORDER_SEGMENTS: () => FOREVER_ORDER_SEGMENTS,
  FeedRequest: () => FeedRequest,
  FeedResponse: () => FeedResponse,
  GLOBAL_EXCHANGE_SEGMENTS: () => GLOBAL_EXCHANGE_SEGMENTS,
  GLOBAL_ORDER_TYPES: () => GLOBAL_ORDER_TYPES,
  GlobalStocks: () => GlobalStocks,
  InstrumentType: () => InstrumentType,
  LegName: () => LegName,
  MARGIN_CALC_PRODUCT_TYPES: () => MARGIN_CALC_PRODUCT_TYPES,
  MARGIN_CALC_SEGMENTS: () => MARGIN_CALC_SEGMENTS,
...
var FOREVER_ORDER_SEGMENTS = MARGIN_CALC_SEGMENTS;
...
function ema(data, period = 20) {
  ...
  data.forEach((price2, index) => {
    ...
    values.push((price2 - previous) * multiplier + previous);
  });
  return values;
}
...
function summarize(params) {
  const price2 = params.price === void 0 ? "" : ` @ ${params.price}`;
  return `${params.transactionType} ${params.quantity} of ${params.exchangeSegment}:${params.securityId} as ${params.orderType}${price2}`;
}
...
__export(schemas_exports, {
  ...
  expiryListSchema: () => expiryListSchema,
  feedSchema: () => feedSchema,
  historicalSchema: () => historicalSchema,
  intradaySchema: () => intradaySchema,
  marginSchema: () => marginSchema,
  modifyOrderSchema: () => modifyOrderSchema,
  optionChainSchema: () => optionChainSchema,
  orderSchema: () => orderSchema2,
  searchSchema: () => searchSchema,
  skillInputSchema: () => skillInputSchema,
  technicalsSchema: () => technicalsSchema
});
init_cjs_shims();
var emptySchema = {
  type: "object",
...
function price(input) {
  const { spot, strike, timeToExpiry, riskFreeRate, volatility, optionType } = input;
...
function greeks(input) {
  ...
  const delta = optionType === "call" ? normalCdf(d1Value) : normalCdf(d1Value) - 1;
  const gamma = pdf / (spot * volatility * sqrtTime);
  const vega = spot * pdf * sqrtTime / 100;
  const decay = -(spot * pdf * volatility) / (2 * sqrtTime);
  const theta = optionType === "call" ? decay - riskFreeRate * strike * discount * normalCdf(d2Value) : decay + riskFreeRate * strike * discount * normalCdf(-d2Value);
  const rho = optionType === "call" ? strike * timeToExpiry * discount * normalCdf(d2Value) : -strike * timeToExpiry * discount * normalCdf(-d2Value);
  return {
    delta,
    gamma,
    theta: theta / 365,
...
function impliedVolatility(input) {
  ...
  for (let iteration = 0; iteration < maxIterations; iteration += 1) {
    ...
    const vega = spot * normalPdf(d1(spot, strike, timeToExpiry, riskFreeRate, iv)) * Math.sqrt(timeToExpiry);
    if (vega < 1e-10) {
      return iv;
    }
    iv = Math.max(iv - difference / vega, 1e-3);
  }
  return iv;
}
function d1(spot, strike, timeToExpiry, riskFreeRate, volatility) {
...
function volumePutCallRatio(chain) {
...
var promptHelpers_exports = {};
__export(promptHelpers_exports, {
  marketAnalysis: () => marketAnalysis,
  orderConfirmation: () => orderConfirmation,
  portfolioSummary: () => portfolioSummary,
  riskReport: () => riskReport,
...
function orderConfirmation(order) {
  const lines = [
    ...
    order.price === void 0 ? "Market Price" : `Price: \u20B9${order.price}`
  ];
  if (order.triggerPrice !== void 0) {
...
__export(generated_exports, {
  ...
  ConditionalTriggersService: () => ConditionalTriggersService,
  DataApiSService: () => DataApiSService,
  EdisBulkFormRequest: () => EdisBulkFormRequest,
  EdisFormRequest: () => EdisFormRequest,
  EdisService: () => EdisService,
  ForeverOrderService: () => ForeverOrderService,
  FundsMarginService: () => FundsMarginService,
  ...
  PositionsPortfolioService: () => PositionsPortfolioService,
  ...
  SuperOrderService: () => SuperOrderService,
  TradeHistoryResponseModel: () => TradeHistoryResponseModel,
  TradeResponse: () => TradeResponse,
  TraderSControlService: () => TraderSControlService
});
init_cjs_shims();
...
var ApiError = class extends Error {
  constructor(request2, response, message2) {
    super(message2);
    this.name = "ApiError";
...
var sendRequest = async (config, options, url, body, formData, headers, onCancel, axiosClient) => {
  const source = import_axios2.default.CancelToken.source();
  const requestConfig = {
    url,
    headers,
    data: body ?? formData,
...
var request = (config, options, axiosClient = import_axios2.default) => {
...
// src/generated/services/ConditionalTriggersService.ts
var ConditionalTriggersService = class {
  /**
   ...
   * @throws ApiError
   */
  static getAlertOrder(accessToken, alertId) {
   ...
   * @throws ApiError
   */
  static modifyAlertOrder(accessToken, alertId, requestBody) {
    return request(OpenAPI, {
      method: "PUT",
      url: "/alerts/orders/{alertId}",
      path: {
   ...
   * @throws ApiError
   */
  static delAlertOrder(accessToken, alertId) {
    return request(OpenAPI, {
      method: "DELETE",
      url: "/alerts/orders/{alertId}",
      path: {
   ...
   * @throws ApiError
   */
  static getAllAlertOrders(accessToken) {
    return request(OpenAPI, {
      method: "GET",
      url: "/alerts/orders",
      headers: {
   ...
   * @throws ApiError
   */
  static alertOrder(accessToken, requestBody) {
    return request(OpenAPI, {
      method: "POST",
      url: "/alerts/orders",
      headers: {
...
var DataApiSService = class {
   ...
   * @throws ApiError
   */
  static optionchart(accessToken, requestBody) {
    return request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  static intradaycharts(accessToken, requestBody) {
    return request(OpenAPI, {
      method: "POST",
      url: "/charts/intraday",
      headers: {
   ...
   * @throws ApiError
   */
  static historicalcharts(accessToken, requestBody) {
    return request(OpenAPI, {
      method: "POST",
...
var EdisService = class {
   ...
   * @throws ApiError
   */
  static edisform(accessToken, requestBody) {
    return request(OpenAPI, {
      method: "POST",
      url: "/edis/form",
      headers: {
   ...
   * @throws ApiError
   */
  static bulkedisform(accessToken, requestBody) {
    return request(OpenAPI, {
      method: "POST",
      url: "/edis/bulkform",
      headers: {
   ...
   * @throws ApiError
   */
  static edisqtystatus(accessToken, isin) {
    return request(OpenAPI, {
      method: "GET",
...
var ForeverOrderService = class {
   ...
   * @throws ApiError
   */
  static modifyforeverorder(accessToken, orderId, requestBody) {
    return request(OpenAPI, {
      method: "PUT",
   ...
   * @throws ApiError
   */
  static cancelforeverorder(accessToken, orderId) {
    return request(OpenAPI, {
      method: "DELETE",
      url: "/forever/orders/{order-id}",
      path: {
   ...
   * @throws ApiError
   */
  static getforeverorders(accessToken) {
    return request(OpenAPI, {
      method: "GET",
      url: "/forever/orders",
      headers: {
   ...
   * @throws ApiError
   */
  static placeforeverorder(accessToken, requestBody) {
    return request(OpenAPI, {
      method: "POST",
      url: "/forever/orders",
      headers: {
...
var FundsMarginService = class {
   ...
   * @throws ApiError
   */
  static margincalculator(accessToken, requestBody) {
    return request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  static margincalculatormulti(accessToken, requestBody) {
    return request(OpenAPI, {
      method: "POST",
...
var IpSetupService = class {
   ...
   * @throws ApiError
   */
  static modifyIp(accessToken, requestBody) {
    return request(OpenAPI, {
      method: "PUT",
      url: "/ip/modifyIP",
      headers: {
   ...
   * @throws ApiError
   */
  static setIp(accessToken, requestBody) {
    return request(OpenAPI, {
      method: "POST",
      url: "/ip/setIP",
      headers: {
...
var OrdersService = class {
   ...
   * @throws ApiError
   */
  static getorderbyorderid(accessToken, orderId) {
    return request(OpenAPI, {
      method: "GET",
      url: "/orders/{order-id}",
      path: {
   ...
   * @throws ApiError
   */
  static modifyorder(accessToken, orderId, requestBody) {
    return request(OpenAPI, {
      method: "PUT",
      url: "/orders/{order-id}",
      path: {
   ...
   * @throws ApiError
   */
  static placeorder(accessToken, requestBody) {
    return request(OpenAPI, {
      method: "POST",
      url: "/orders",
      headers: {
   ...
   * @throws ApiError
   */
  static placesliceorder(accessToken, requestBody) {
    return request(OpenAPI, {
      method: "POST",
      url: "/orders/slicing",
      headers: {
   ...
   * @throws ApiError
   */
  static getalltrades(accessToken) {
    return request(OpenAPI, {
      method: "GET",
      url: "/trades",
      headers: {
   ...
   * @throws ApiError
   */
  static gettradebyorderid(accessToken, orderId) {
    return request(OpenAPI, {
      method: "GET",
      url: "/trades/{order-id}",
      path: {
   ...
   * @throws ApiError
   */
  static gettradehistory(accessToken, fromDate, toDate, pageNumber) {
    return request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  static getorderbycorrelationid(accessToken, correlationId) {
    return request(OpenAPI, {
      method: "GET",
...
init_cjs_shims();
var PositionsPortfolioService = class {
  /**
   * convert position
   ...
   * @throws ApiError
   */
  static convertposition(accessToken, requestBody) {
    return request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  static getpositions(accessToken) {
    return request(OpenAPI, {
      method: "GET",
      url: "/positions",
      headers: {
   ...
   * @throws ApiError
   */
  static orderExitAll(accessToken) {
    return request(OpenAPI, {
      method: "DELETE",
      url: "/positions",
      headers: {
   ...
   * @throws ApiError
   */
  static getholdings(accessToken) {
    return request(OpenAPI, {
      method: "GET",
      url: "/holdings",
      headers: {
...
var StatementsService = class {
   ...
   * @throws ApiError
   */
  static ledger(accessToken, fromDate, toDate) {
    return request(OpenAPI, {
      method: "GET",
      url: "/ledger",
      headers: {
...
var SuperOrderService = class {
   ...
   * @throws ApiError
   */
  static modifysuperorder(accessToken, orderId, requestBody) {
    return request(OpenAPI, {
      method: "PUT",
   ...
   * @throws ApiError
   */
  static getsuperorders(accessToken) {
    return request(OpenAPI, {
      method: "GET",
      url: "/super/orders",
      headers: {
   ...
   * @throws ApiError
   */
  static placesuperorder(accessToken, requestBody) {
    return request(OpenAPI, {
      method: "POST",
      url: "/super/orders",
      headers: {
   ...
   * @throws ApiError
   */
  static cancelsuperorder(accessToken, orderId, orderLeg) {
    return request(OpenAPI, {
      method: "DELETE",
...
init_cjs_shims();
var TraderSControlService = class {
  /**
   * get P&L based exit
   ...
   * @throws ApiError
   */
  static pnlExit(accessToken, requestBody) {
    return request(OpenAPI, {
      method: "POST",
      url: "/pnlExit",
      headers: {
   ...
   * @throws ApiError
   */
  static stopPnlExit(accessToken) {
    return request(OpenAPI, {
      method: "DELETE",
      url: "/pnlExit",
      headers: {
   ...
   * @throws ApiError
   */
  static killSwitchStatus(accessToken) {
    return request(OpenAPI, {
      method: "GET",
      url: "/killswitch",
      headers: {
   ...
   * @throws ApiError
   */
  static killswitch(accessToken, killSwitchStatus) {
    return request(OpenAPI, {
      method: "POST",
      url: "/killswitch",
      headers: {
...
function volatilitySize(input) {
  const { accountBalance, riskPercent, entryPrice, atr: atr2 } = input;
  const atrMultiplier = input.atrMultiplier ?? 2;
  if (accountBalance <= 0 || entryPrice <= 0 || atr2 <= 0) {
    return 0;
  }
  return fixedRiskSize({
    ...
    riskPercent,
    entryPrice,
    stopLossPrice: entryPrice - atr2 * atrMultiplier,
    lotSize: input.lotSize
  });
}
function percentageStop(entryPrice, riskPercent) {
  if (entryPrice <= 0 || riskPercent <= 0) {
    return 0;
  }
  return entryPrice * (1 - riskPercent / 100);
}
function atrStop(entryPrice, atr2, multiplier = 2) {
  if (entryPrice <= 0 || atr2 <= 0) {
    return 0;
  }
  return entryPrice - atr2 * multiplier;
}
function supportStop(entryPrice, supportLevels, buffer = 5e-3) {
...
function takeProfit(entryPrice, stopLossPrice, riskRewardRatio = 2) {
  if (entryPrice <= 0 || stopLossPrice <= 0) {
    return 0;
  }
  return entryPrice + Math.abs(entryPrice - stopLossPrice) * riskRewardRatio;
}
var TrailManager = class {
  constructor(entryPrice, initialStop, atr2, trailMultiplier = 2) {
...
// src/types/super-order.types.ts
init_cjs_shims();
